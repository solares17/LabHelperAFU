...
const TABLE_3_ANGLE_MAGNETIC = {
    ...
    columns: ['θ, °', 'E, дБ(мкВ/м)', 'I, мкА'],
    rows: [
        { angle_deg: -90, E_mkVm: 4.3, I_mkA: 38 },
        { angle_deg: -75, E_mkVm: 8.4, I_mkA: 12 },
        { angle_deg: -60, E_mkVm: 4.0, I_mkA: 85 },
        { angle_deg: -45, E_mkVm: -6.2, I_mkA: 30 },
        { angle_deg: -30, E_mkVm: 6.4, I_mkA: 10 },
        { angle_deg: -15, E_mkVm: 9, I_mkA: 15 },
        { angle_deg:   0, E_mkVm: 6.7, I_mkA: 38 },
        { angle_deg:  15, E_mkVm: 9, I_mkA: 15 },
        { angle_deg:  30, E_mkVm: 6.4, I_mkA: 10 },
        { angle_deg:  45, E_mkVm: -6.2, I_mkA: 30 },
        { angle_deg:  60, E_mkVm: 4.5, I_mkA: 85 },
        { angle_deg:  75, E_mkVm: 8.4, I_mkA: 12 },
        { angle_deg:  90, E_mkVm: 4.3, I_mkA: 38 },
    ],
};
